    ...
    >
      <ScrollView contentContainerClassName="px-6 py-6 flex-grow pb-12">
        ...
        <Controller control={control} name="soil_type" render={({ field: { onChange, onBlur, value } }) => (
          <Input label="Soil Type" placeholder="e.g. Loam" onBlur={onBlur} onChangeText={onChange} value={value} error={typeof errors.soil_type?.message === "string" ? errors.soil_type.message : undefined} />
        )} />

        <View className="flex-row justify-between w-full">
          <View className="w-[48%]">
            <Controller control={control} name="moisture" render={({ field: { onChange, onBlur, value } }) => (
              <Input label="Moisture (%)" placeholder="0-100" keyboardType="numeric" onBlur={onBlur} onChangeText={onChange} value={value ? String(value) : ''} error={typeof errors.moisture?.message === "string" ? errors.moisture.message : undefined} />
            )} />
          </View>
          <View className="w-[48%]">
            <Controller control={control} name="ph" render={({ field: { onChange, onBlur, value } }) => (
              <Input label="pH Level" placeholder="0-14" keyboardType="numeric" onBlur={onBlur} onChangeText={onChange} value={value ? String(value) : ''} error={typeof errors.ph?.message === "string" ? errors.ph.message : undefined} />
            )} />
          </View>
        </View>

        <Controller control={control} name="nitrogen" render={({ field: { onChange, onBlur, value } }) => (
          <Input label="Nitrogen Level" placeholder="e.g. High, Medium, Low" onBlur={onBlur} onChangeText={onChange} value={value} error={typeof errors.nitrogen?.message === "string" ? errors.nitrogen.message : undefined} />
        )} />

        <Controller control={control} name="phosphorus" render={({ field: { onChange, onBlur, value } }) => (
          <Input label="Phosphorus Level" placeholder="e.g. High, Medium, Low" onBlur={onBlur} onChangeText={onChange} value={value} error={typeof errors.phosphorus?.message === "string" ? errors.phosphorus.message : undefined} />
        )} />

        <Controller control={control} name="potassium" render={({ field: { onChange, onBlur, value } }) => (
          <Input label="Potassium Level" placeholder="e.g. High, Medium, Low" onBlur={onBlur} onChangeText={onChange} value={value} error={typeof errors.potassium?.message === "string" ? errors.potassium.message : undefined} containerClassName="mb-6" />
        )} />
