    ...
    >
      <ScrollView contentContainerClassName="px-6 py-6 flex-grow pb-12">
        ...
        <Controller control={control} name="farmerName" render={({ field: { onChange, onBlur, value } }) => (
          <Input label="Farmer Name" placeholder="e.g. John Doe" onBlur={onBlur} onChangeText={onChange} value={value} error={errors.farmerName?.message} />
        )} />

        <Controller control={control} name="farmName" render={({ field: { onChange, onBlur, value } }) => (
          <Input label="Farm Name" placeholder="e.g. Green Acres" onBlur={onBlur} onChangeText={onChange} value={value} error={errors.farmName?.message} />
        )} />

        <Controller control={control} name="location" render={({ field: { onChange, onBlur, value } }) => (
          <Input label="Location" placeholder="City, State" onBlur={onBlur} onChangeText={onChange} value={value} error={errors.location?.message} />
        )} />

        <View className="flex-row justify-between w-full">
          <View className="w-[48%]">
            <Controller control={control} name="size" render={({ field: { onChange, onBlur, value } }) => (
              <Input label="Size (Acres)" placeholder="0.0" keyboardType="numeric" onBlur={onBlur} onChangeText={onChange} value={value ? String(value) : ''} error={errors.size?.message} />
            )} />
          </View>
          <View className="w-[48%]">
            <Controller control={control} name="soilType" render={({ field: { onChange, onBlur, value } }) => (
              <Input label="Soil Type" placeholder="e.g. Loam" onBlur={onBlur} onChangeText={onChange} value={value} error={errors.soilType?.message} />
            )} />
          </View>
        </View>

        <Controller control={control} name="waterSource" render={({ field: { onChange, onBlur, value } }) => (
          <Input label="Water Source" placeholder="e.g. Well, River" onBlur={onBlur} onChangeText={onChange} value={value} error={errors.waterSource?.message} />
        )} />

        <Controller control={control} name="currentCrop" render={({ field: { onChange, onBlur, value } }) => (
          <Input label="Current Crop" placeholder="e.g. Corn" onBlur={onBlur} onChangeText={onChange} value={value} error={errors.currentCrop?.message} />
        )} />

        <Controller control={control} name="plantingDate" render={({ field: { onChange, onBlur, value } }) => (
          <Input label="Planting Date" placeholder="YYYY-MM-DD" onBlur={onBlur} onChangeText={onChange} value={value} error={errors.plantingDate?.message} containerClassName="mb-6" />
        )} />
